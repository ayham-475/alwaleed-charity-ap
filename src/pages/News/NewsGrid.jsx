  ...
  const articles = [
    {
      ...
      description: 'يبحث الكثير من الأشخاص عن طريقة التواصل مع الأميرة ريم بنت الوليد بن طلال، سواء للاستفسار عن المبادرات الإنسانية أو لمعرفة وسائل التواصل المتاحة. ولهذا قمنا بتوفير هذه الصفحة لتسهيل الوصول...',
      image: 'https://alweleedphilanthopies.com/storage/news/media/9aCuGOPz8qKEmm9TekZWVtCcQYK6TN2Smcyj1yeb.jpg',
    },
    {
      id: 2,
      date: '2026/06/27',
      ...
      description: 'يتساءل العديد من الأشخاص عن طريقة التواصل مع صاحبة السمو الملكي الأميرة لمياء بنت ماجد آل سعود فيما يتعلق بالمبادرات الإنسانية والمجتمعية والبرامج التنموية التي تهدف إلى خدمة المجتمع...',
    ...
    },
    {
      ...
      description: 'إذا كنت تبحث عن طريقة التواصل مع مؤسسة الوليد للإنسانية للاستفسار عن المبادرات الإنسانية أو البرامج التنموية أو الخدمات المقدمة للمستفيدين، فيمكنك التواصل مباشرة عبر الرقم المخصص لاستقبال الاستفسارات والطلبات.',
    ...
    },
    {
      ...
      publisher: 'مكتب الوليد بن...',
      publisherLogo: 'https://alweleedphilanthopies.com/storage/posts/IyBA3YsNBvGQ2xanK9DNzK2Mgv4LEfbtOLwegIJA.jpg',
      title: 'مؤسسة الوليد للإنسانية ودورها في دعم المبادرات',
      description: 'تُعد مؤسسة الوليد للإنسانية من الجهات المعروفة في مجال العمل الإنساني والتنمية المجتمعية، حيث تسعى إلى دعم المبادرات التي تساهم في تحسين جودة الحياة وتعزيز فرص التنمية المستدامة.',
    ...
    },
    {
      ...
      description: 'بعد إرسال طلبك إلى مؤسسة الوليد للإنسانية يمكنك متابعة حالة الطلب باستخدام رقم الطلب الخاص بك. ويعمل فريق خدمة المستفيدين على تحديث الحالات بشكل دوري لضمان الشفافية وسرعة الإنجاز والرد على كافة استفسارات المستفيدين.',
      image: 'https://alweleedphilanthopies.com/storage/news/media/lDgJhqnsydZd38AjKoNufjdQetIedJxVF9iXto7T.jpg',
    },
    {
      id: 6,
      ...
      publisher: 'مكتب الوليد بن...',
      publisherLogo: 'https://alweleedphilanthopies.com/storage/posts/IyBA3YsNBvGQ2xanK9DNzK2Mgv4LEfbtOLwegIJA.jpg',
      title: 'أهمية العمل الإنساني في تحسين جودة الحياة',
      description: 'يلعب العمل الإنساني دورًا محوريًا في دعم المجتمعات وتعزيز الاستقرار الاجتماعي من خلال المبادرات التي تستهدف تحسين مستوى المعيشة.',
    ...
    },
    {
      ...
      description: 'تعتبر المبادرات التنموية من أهم الأدوات التي تساعد على تحسين حياة الأفراد والمجتمعات من خلال الاستثمار في التعليم والتدريب.',
      image: 'https://alweleedphilanthopies.com/storage/news/media/JZ6sXOR1FrkBLrj5yxeEuwhZbyK4qf8yRPzQ6H7D.jpg',
    },
    {
      id: 8,
      date: '2026/01/06',
      publisher: 'مؤسسة الوليد...',
      publisherLogo: 'https://alweleedphilanthopies.com/storage/posts/IyBA3YsNBvGQ2xanK9DNzK2Mgv4LEfbtOLwegIJA.jpg',
      title: 'مع كل أثر نحققه نجدد التزامنا',
      description: 'منذ أكثر من 45 عامًا، نواصل الاستثمار في الإنسان إيمانًا بأنه أساس التنمية ومحرك التغيير. ونجدد رؤيتنا والتزامنا بمواصلة العمل المستدام لتمكين المجتمعات.',
      image: 'https://alweleedphilanthopies.com/storage/hero/ECTiEWhTG4I3WWlPvcX20ylG0SIKFQngoOk5dqOe.jpg',
    },
    {
      id: 9,
      date: '2026/01/03',
      ...
      description: 'التقديم على برامج ومبادرات مؤسسة الوليد للإنسانية تواصل مؤسسة الوليد للإنسانية جهودها في دعم الفئات الأكثر احتياجًا من خلال مجموعة من البرامج التنموية المستدامة.',
    ...
    },
    {
      ...
      description: 'تتولى الأستاذة لبنى الناهض منصب مدير الإعلام والعلاقات العامة في مؤسسة الوليد للإنسانية، حيث تسهم بشكل فعال في إبراز جهود المؤسسة ومبادراتها التنموية.',
