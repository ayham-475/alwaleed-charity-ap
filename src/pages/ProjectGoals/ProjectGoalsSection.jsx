...
export default function ProjectGoalsSection() {
  ...
  const goalsData = [
    ...
    },
    {
      ...
      description: 'دعم وتمويل المشاريع الصغيرة والمتناهية الصغر لتأهيل الشباب والنساء ودعم استقلالهم الاقتصادي وتحقيق التنمية المستدامة في المجتمعات النامية.',
      image: 'https://alweleedphilanthopies.com/storage/posts/uV1NxpqV7zvf1j6S4VLA6L7ay5c4Ib5xm4ArJtgM.jpg',
    },
    {
      id: 3,
      title: 'تطوير القطاع الصحي',
      description: 'تقديم الدعم اللوجستي والمعدات الطبية الحديثة للمستشفيات والمراكز الصحية في المناطق الأكثر احتياجاً لضمان توفير رعاية صحية متكاملة.',
